...
function displayProducts() {
    ...
    // Filter products to only include those in the "accessories" category
    const accessoriesProducts = dataPro.filter(product => product.category.toLowerCase() === 'accessories');
    ...
    document.querySelectorAll('.product-link, .product-thumb').forEach(link => {
        link.addEventListener('click', (e) => {
            ...
            const selectedProduct = accessoriesProducts.find(product => product.title === productId);
